<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="PurchasePage.aspx.vb" Inherits="PurchasePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <table border="1">
                <tr>
                    ...
                    <td>
                        ...
                        Seller: <asp:Label ID="lblSeller" runat="server"></asp:Label><br /><br />
                        Buyer: <asp:Label ID="lblBuyer" runat="server"></asp:Label><br /><br />
    ...
    <asp:Panel ID="pnlApproveWork" Visible="false" runat="server">
        <div style="border-radius: 10px; border: 1px solid gray; width: 100%; min-height: 200px;">
            <div style="width: 100%; text-align: center;"><h2>Approve your work</h2></div>
