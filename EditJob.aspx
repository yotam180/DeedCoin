<%@ Page Title="" Language="VB" ValidateRequest="false" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="EditJob.aspx.vb" Inherits="EditJob" %>
        ...
        <tr>
            <td style="width: 20%; text-align: center;"></td><td>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <b>Title:</b><br />
                        <asp:TextBox placeholder="Job title" CssClass="large_txt" style="font-size: 17px;" ID="txtTitle" runat="server" Width="70%" Font-Bold="True" AutoPostBack="True" TabIndex="1"></asp:TextBox>
                        <br />
                        ...
                        <br />
                        <b>Salary:</b><br />
                        <asp:TextBox placeholder="Salary (in DeedCoins)" CssClass="large_txt" style="font-size: 17px;" ID="txtPrice" runat="server" Width="70%" Font-Bold="True" AutoPostBack="True" TabIndex="2"></asp:TextBox>
                        <br />
                        <b>Video URL:</b><br />
