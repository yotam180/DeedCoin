<%@ Page Language="VB" ValidateRequest="false" AutoEventWireup="false" CodeFile="GigPage.aspx.vb" Inherits="GigPage" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <tr>
                ...
                <td style="width: 200px; vertical-align: top; text-align: center;">
                    ...
                    <div style="width: 100%; text-align: center; border: 1px solid; border-color: lightgray; border-radius: 10px;">
                        <span style="color: darkslategray; font-size: small; font-family: 'Arial Rounded MT'">&nbsp;&nbsp;&nbsp;Seller: </span>
                    ...
                    <table style="width: 100%; height: 100%; position: relative; table-layout: fixed;" border="0" cellpadding="5">
                        <tr>
                            <td colspan="2" style="vertical-align: top;">
                                <h2 style="display: inline-block;"><asp:Label ID="lblFullName" runat="server" Text="Label"></asp:Label></h2> (price: <asp:Label ID="lblPrice" runat="server"></asp:Label> dC)
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: top; color: rgb(102, 102, 102); font: normal normal normal normal 13px / 16.9px Arial, 'Helvetica Neue', Helvetica, sans-serif;">
                                ...
                                <asp:LinkButton ID="btnBuy" runat="server"><h2 style="padding: 5px; border-radius: 10px; background-color: lawngreen; text-align: center; border: 3px solid gold;">Buy for <asp:Label ID="lblPriceShow" runat="server"></asp:Label> dC</h2></asp:LinkButton>
    ...
    <asp:Panel ID="pnlNotFound" runat="server" Visible="false">
        <div style="width: 100%; text-align: center;">
            <h2>Sorry.. This gig was not found :(</h2>
        </div>
    </asp:Panel>
</asp:Content>
