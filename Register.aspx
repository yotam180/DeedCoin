<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Register.aspx.vb" Inherits="Register" ValidateRequest="false" %>
            ...
            <td style="width: 20%; text-align: center;"></td><td>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <br />
                        <asp:TextBox type="password" placeholder="Password" CssClass="large_txt" style="font-size: 17px;" ID="txtPassword" runat="server" Width="70%" Font-Bold="True" AutoPostBack="True" TabIndex="2"></asp:TextBox>
                        <br />
                        ...
                        <br />
                        <asp:TextBox placeholder="Email" CssClass="large_txt" style="font-size: 17px;" ID="txtEmail" runat="server" Width="70%" Font-Bold="True" AutoPostBack="True" TextMode="SingleLine" TabIndex="4"></asp:TextBox>
                        <br />
                        ...
                        <br />
                        <asp:TextBox placeholder="Address/Location (ex. HaZafon, Israel)" CssClass="large_txt" style="font-size: 17px;" ID="txtAddress" runat="server" Width="70%" Font-Bold="True" AutoPostBack="True" TextMode="SingleLine" TabIndex="6"></asp:TextBox>
                        <br />
                ...
                <asp:LinkButton ID="btnRegister" runat="server" TabIndex="7">
                    <div class="button_div" style="left: 30%; width: 40%; height: 20px; position: relative;">Sign up</div>
                </asp:LinkButton>
