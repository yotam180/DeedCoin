<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddGig.aspx.vb" Inherits="AddGig" MasterPageFile="~/MasterPage.master" %>
        ...
        <tr>
            <td style="width: 20%; text-align: center;"></td><td>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:TextBox placeholder="Gig name" CssClass="large_txt" style="font-size: 17px;" ID="txtGigName" runat="server" Width="70%" Font-Bold="True" AutoPostBack="True" TabIndex="1"></asp:TextBox>
                        <br />
                        ...
                        <br />
                        <asp:TextBox placeholder="Price (in deedCoins)" CssClass="large_txt" style="font-size: 17px;" ID="txtPrice" runat="server" Width="100%" Font-Bold="True" AutoPostBack="True" TabIndex="1"></asp:TextBox>
                        <br />
                        ...
                        <br />
                        * First image URL will be the featured image of your gig.
                        <br /><br />
                    </ContentTemplate>
                </asp:UpdatePanel>
